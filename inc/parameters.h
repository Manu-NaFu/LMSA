...
public:
    ...
    inline int  getSafetyDistance() const {return this->safety_distance_;}
    inline int  getPercOccupancy() const {return this->perc_occupancy_;}
    inline char getHeuristic() const {return this->heuristic_;}
    ...
    inline void setSafetyDistance(const int & safety_distance) {this->safety_distance_ = safety_distance;}
    inline void setPercOccupancy(const int &perc_oc) {this->perc_occupancy_ = perc_oc;}
    inline void setHeuristic(const char &heuristic) {this->heuristic_ = heuristic;}
