...
private slots:
    ...
    void btnparameters(); //Slot executed when the button to set the parameters is clicked.
    ...
    //void on_auto_rb_clicked();

    void on_b_end_sim_clicked();

    void joypad_y_changed(float value);
    void joypad_x_changed(float value);
